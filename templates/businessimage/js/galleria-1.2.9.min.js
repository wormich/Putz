(function ($) {
    ...
    Galleria = function () {
        ...
        var _timer = this._timer = {
            trunk: {}, add: function (id, fn, delay, loop) {
    ...
    Galleria.prototype = {
        ...
        init: function (target, options) {
            ...
            this._options = {
                ...
                dummy: undef,
                easing: "galleria",
                extend: function (options) {}, fullscreenCrop: undef,
            ...
            $.each(this._data, function (i, data) {
                ...
                if ("video" in data) {
                    ...
                    if (result) {
                        current.iframe = _video[result.provider].embed(result.id) +
                        function () {
