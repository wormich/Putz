    ...
    <section class="mini-layout">
        <div class="frame_title clearfix">
            ...
            <div class="pull-right">
                <div class="d-i_b">
                    <a href="/admin/categories/edit/{$orig_cat.id}" class="t-d_n m-r_15"><span class="f-s_14">←</span>
                        <span class="t-d_u">{lang("Back","admin")}</span></a>
                    <button type="button" class="btn btn-small btn-primary  action_on formSubmit" data-action="close"
                            data-form="#save"><i class="icon-ok icon-white"></i>{lang("Save","admin")}</button>
                    <button type="button" class="btn btn-small action_on formSubmit" data-action="exit"
                        ...
                        <ul class="dropdown-menu pull-right">
                            {foreach $langs as $l}
                                {if $l.id != $lang}
                                    ...
                                    {else:}
                                        <li>
                                            <a href="/admin/categories/translate/{$orig_cat.id}/{$l.id}">{$l.lang_name}</a>
                                        </li>
                                    {/if}
                                {/if}
                            {/foreach}
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label"
                                                           for="short_desc">{lang("Description","admin")}:</label>

                                                    <div class="controls">
                                                        <textarea class="elRTE" name="short_desc"
                                                                  id="short_desc">{htmlspecialchars($cat.short_desc)}</textarea>
                                                    </div>
                                                </div>

                                                <div class="control-group"><label class="control-label"
                                                                                  for="title">{lang("Meta Title","admin")}
                                                        :</label>
                                                ...
                                                <div class="control-group"><label class="control-label"
                                                    ...
                                                    <div class="controls">
                                                        <textarea id="description" name="description" rows="10"
                                                                  cols="180">{$cat.description}</textarea>
                                                    </div>
                                                </div>
                                                <div class="control-group"><label class="control-label"
                                                    ...
                                                    <div class="controls">
                                                        <textarea id="keywords" name="keywords" rows="10"
                                                                  cols="180">{$cat.keywords}</textarea>
                                                    </div>
                                                </div>
