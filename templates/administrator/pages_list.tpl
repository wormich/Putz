    ...
    <section class="mini-layout">
        <div class="frame_title clearfix">
            ...
            <div class="pull-right">
                <div class="d-i_b">
                    <button type="submit" class="btn btn-small disabled action_on listFilterSubmitButton d_n" disabled="disabled" ><i class="icon-filter"></i>{lang('Filter','admin')}</button>
        ...
        <div class="row-fluid">
            ...
            {/if}
            <div class="{if $show_cat_list == 'yes'}span9{else:}span12{/if}">
                <div class="inside_padd">
                        ...
                        <tbody data-url="" class="sortable ui-sortable">
                            ...
                            <tr data-id="{$page.id}">
                                ...
                                <td class="share_alt">
                                    ...
                                    <div class="o_h">
                                        <a href="{$BASE_URL}admin/pages/edit/{$page.id}" class="title" data-rel="tooltip" data-original-title="{lang("Edit page","admin")}">{$page.title}</a>
                                    </div>
                                </td>
