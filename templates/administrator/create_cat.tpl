    ...
    <section class="mini-layout">
        <div class="frame_title clearfix">
            ...
            <div class="pull-right">
                <div class="d-i_b">
                    <a href="/admin/categories/cat_list" class="t-d_n m-r_15"><span class="f-s_14 pjax">←</span>
                        <span class="t-d_u">{lang("Back","admin")}</span></a>
                    <button type="button" class="btn btn-small action_on btn-success formSubmit" data-action="edit" data-form="#save" data-submit>
                    ...
                    <button type="button" class="btn btn-small action_on formSubmit" data-action="close" data-form="#save">
                        <i class="icon-check"></i>{lang("Create and exit","admin")}</button>
                </div>
            </div>
        </div>
        <div class="clearfix">
                            ...
                            <td colspan="6">
                                <div class="inside_padd">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="group_icon pull-right">
                                                    <div class="">
                                                        <button onclick="translite_title('#name', '#url');" type="button" class="btn btn-small" id="translateCategoryTitle">
                                                            <i class="icon-refresh"></i>&nbsp;&nbsp;{lang("AutoFit","admin")}
                                                        </button>
                                                    </div>
                                                </div>
                                                <div class="o_h">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="parent_id">{lang('Parent category','admin')}
                                                :</label>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="category_field_group">{lang("Field group","admin")}
                                                :</label>
                                            ...
                                            <div class="controls">
                                                ...
                                                <p class="help-block">{lang("Select a field group for a category","admin")}
                                                    .</p>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="field_group">{lang("Pages fields group","admin")}
                                                :</label>
                                            ...
                                            <div class="controls">
                                                ...
                                                <span class="help-block">{lang("Select a field group to be displayed/ viewed in the created category of the group or group category", 'admin')}
                                                    .</span>
                                                    <span class="frame_label no_connection">
                                                        <span class="niceCheck b_n">
                        ...
                        <tr>
                            <td colspan="6">
                                <div class="inside_padd">
                                    <div class="form-horizontal">
                                        <div class="control-group">
                                            <label class="control-label" for="order_by">{lang("Sort by","admin")}
                                                :</label>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="main_tpl">{lang("Main template","admin")}
                                                :</label>
                                            ...
                                            <span class="d_b">
                                                <select type="text" name="main_tpl" style="width:220px">
                                                    ...
                                                    {foreach $template_files as $template_file}
                                                        <option value="{echo $template_file}">{echo $template_file}</option>
                                                    {/foreach}
                                                </select>
                                            </span>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="page_tp">{lang("Page template","admin")}
                                                :</label>
                        ...
                        <tr>
                            <td colspan="6">
                                <div class="inside_padd">
                                    <div class="form-horizontal">
                                        <div class="control-group">
                                            <label class="control-label" for="title">{lang("Meta Title","admin")}
                                                :</label>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="descriptions">{lang("Meta Description","admin")}
                                                :</label>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="keywordss">{lang("Meta Keywords","admin")}
                                                :</label>
