                ...
                <td>
                    <div class="inside_padd">
                        <div class="control-group">
                            <label class="control-label" for="comcount">{lang("Order by", 'core')}:</label>
                            <div class="controls">
                                <select name="display" id="comcount">
                                    ...
                                    <option value="position" {if $widget.settings.display == 'position'} selected="selected" {/if}>{lang("By position","core")}</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="sort_order">
                                    <option value="desc" {if $widget.settings.sort_order == 'desc'} selected="selected" {/if}>{lang("In descending order","core")}</option>
                                    <option value="asc" {if $widget.settings.sort_order == 'asc'} selected="selected" {/if}>{lang("In ascending order","core")}</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
